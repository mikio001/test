...
Partial Class zulu_cms_EditModeToolbox
    ...
    Protected Sub EditModeToolbox_Callback_Callback(ByVal source As Object, ByVal e As DevExpress.Web.CallbackEventArgs) Handles EditModeToolbox_Callback.Callback
