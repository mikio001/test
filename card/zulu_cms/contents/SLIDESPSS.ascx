<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SLIDESPSS.ascx.vb" Inherits="zulu_cms_contents_SlideCalendar" %>
...
<uc2:StartEditorToolbox ID="StartEditorToolbox1" runat="server" />
 ...
 <cc1:DirectRender ID="NewEditor" runat="server" />
                
<uc1:editortoolbox ID="EndEditorToolbox1" runat="server" EditorPage="HtmlEditor" />
