<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NewsReader.ascx.vb" Inherits="zulu_cms_contents_NewsReader" %>
<%@ Register src="../StartToolbox.ascx" tagname="StartEditorToolbox" tagprefix="uc1" %>
