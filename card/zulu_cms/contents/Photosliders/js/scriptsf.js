...
var slider = {
	...
	slide: function(pos) {
		...
		//alert(document.getElementById("slide-img-1").style.zIndex);
		//alert(document.getElementById("slide-img-2").style.zIndex);
		//alert(document.getElementById("slide-img-3").style.zIndex);
		//alert(document.getElementById("slide-img-4").style.zIndex);
		...
		for (var i = 0; i < slider.num; i++) {
			...
			if (i == pos) {
				document.getElementById("slide-img-" + (i + 1)).style.zIndex = 99;
			} else {
				document.getElementById("slide-img-" + (i + 1)).style.zIndex = 1;
			}
		}
