<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NewsOtherSITE.ascx.vb" Inherits="zulu_cms_contents_NewsTopList" %>
...
<%@ Register assembly="DevExpress.Web.v21.1, Version=21.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
 ...
 <uc1:StartEditorToolbox ID="StartEditorToolbox1" runat="server" /><table style="width: 100%">
    <tr>
        <td>
