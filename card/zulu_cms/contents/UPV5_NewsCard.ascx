<%@ Control Language="VB" AutoEventWireup="false" CodeFile="UPV5_NewsCard.ascx.vb" Inherits="zulu_cms_contents_NewsCard" %>
...
<uc2:EndEditorToolbox ID="GalleryEnd" runat="server" 
    CustomAddPage="NewCardForm" CustomEditPage="NewCardEditor" />