<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NewsTopListOtherSITEIN.ascx.vb" Inherits="zulu_cms_contents_NewsTopList" %>
...
<table style="width: 100%">
    ...
    <tr>
        <td><cc1:DirectRender ID="NewsTopList" runat="server" />


          <%--  <ul><li style="border-bottom-style: dotted; border-bottom-width: 1px; border-bottom-color: #C0C0C0"></li></ul>--%>
