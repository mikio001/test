<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SlideCalendarVertical.ascx.vb" Inherits="zulu_cms_contents_SlideCalendar" %>
...
<cc1:DirectRender ID="SlideCalendar" runat="server" />
