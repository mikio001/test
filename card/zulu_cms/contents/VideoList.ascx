<%@ Control Language="VB" AutoEventWireup="false" CodeFile="VideoList.ascx.vb" Inherits="zulu_cms_contents_Gallery" %>
...
<cc1:DirectRender ID="Youtube" runat="server"  ContentID="UPVideo" />
