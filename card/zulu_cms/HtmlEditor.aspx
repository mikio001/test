<%@ Page Title="" Language="VB" MasterPageFile="~/zulu_web/VCMasterPage.master" AutoEventWireup="false"
    CodeFile="HtmlEditor.aspx.vb" Inherits="zulu_cms_Editor" %>
...
<%@ Register Assembly="DevExpress.Web.ASPxSpellChecker.v21.1, Version=21.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="pageHeader">
        ...
        <div class="pageHeaderTitle">
            <asp:Literal ID="PageTitle" runat="server" Mode="PassThrough" Text="Content Editor"></asp:Literal>
        </div>
    </div>
    <table cellpadding="0" cellspacing="2" style="padding-left: 6px;">
        <tr>
            <td>
                <dx:ASPxButton ID="btnAdd" runat="server" Text="เพิ่ม" Visible="False">
                    <Image Url="~/zulu_web/images/add.gif">
                    </Image>
                </dx:ASPxButton>
            </td>
            <td>
                <dx:ASPxButton ID="btnEdit" runat="server" Text="แก้ไข" Visible="False">
                    <Image Url="~/zulu_web/images/edit.gif">
                    </Image>
                </dx:ASPxButton>
            </td>
            <td>
                <dx:ASPxButton ID="btnDelete" runat="server" Text="ลบ" Visible="False">
                    <Image Url="~/zulu_web/images/delete.gif">
                    </Image>
                </dx:ASPxButton>
            </td>
            <td>
                <dx:ASPxButton ID="btnSave" runat="server" Text="บันทึก" Visible="False">
                    <Image Url="~/zulu_web/images/ok.gif">
                    </Image>
                </dx:ASPxButton>
            </td>
            <td>
                <dx:ASPxButton ID="btnAcl" runat="server" Text="แก้ไขสิทธิ์" Visible="False">
                    <Image Url="~/zulu_web/images/users.gif">
                    </Image>
                </dx:ASPxButton>
            </td>
            <td>
    ...
    <tr>
        <td colspan="2"><dx:ASPxHtmlEditor ID="ASPxHtmlEditor1" runat="server">
<SettingsImageUpload>
...
<CommonSettings AllowedFileExtensions=".rtf, .pdf, .doc, .docx, .odt, .txt, .xls, .xlsx, .ods, .ppt, .pptx, .odp" 
        RootFolder="~/Main/FileManager/"></CommonSettings>
    <EditingSettings AllowCreate="True" AllowDelete="True" />
