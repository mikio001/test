<%@ Control Language="VB" AutoEventWireup="false" CodeFile="VideoEditor.ascx.vb" Inherits="zulu_cms_editors_LinkEditor" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="title" VisibleIndex="1" 
            Caption="ชื่อรายการ" Width="200px">
        ...
        <dx:GridViewDataComboBoxColumn Caption="ประเภทเนื้อหา" FieldName="contentType" 
            VisibleIndex="2">
        ...
        <dx:GridViewDataMemoColumn Caption="คำอธิบาย" FieldName="contentBody" 
         ...
         <dx:GridViewDataTextColumn FieldName="refUrl" VisibleIndex="1" 
            Caption="URL" Width="200px">
            <PropertiesTextEdit Width="200px">
                <ValidationSettings>
                    <RequiredField IsRequired="True" />
                </ValidationSettings>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    InsertCommand="INSERT INTO [ZCMS_CONTENT] ([title], [contentBody], [contentID], [orderNo], [refUrl], [siteID],[modifyBy],[modifyDate], [editorID],createDate,createBy,status,contentType) VALUES (@title, @contentBody, @contentID, @orderNo, @refUrl, @siteID,@modifyBy,GETDATE(), 'VIDEO',GETDATE(),@modifyBy,0,@contentType)"
