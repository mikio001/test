<%@ Page Title="" Language="VB" MasterPageFile="~/zulu_web/VCMasterPage.master" AutoEventWireup="false" CodeFile="NewFormNews.aspx.vb" Inherits="zulu_cms_editors_NewEditer" %>
...
<td>
    <dx:ASPxMemo ID="newsSubTitle" runat="server" Height="71px" MaxLength="500" Width="475px">
    </dx:ASPxMemo>
...
<td>
 <%--   <cc1:FileSelector ID="btnRefImg" runat="server" Width="400px">
    ...
    <table><tr><td> <asp:FileUpload ID="btnRefImg" runat="server" /> </td><td><asp:TextBox ID="txtRefImg" runat="server"></asp:TextBox></td></tr></table>
