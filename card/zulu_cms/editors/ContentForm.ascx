<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ContentForm.ascx.vb" Inherits="zulu_cms_editors_NewsAdd" %><%@ Register assembly="DevExpress.Web.v21.1, Version=21.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
