<%@ Page Title="" Language="VB" MasterPageFile="~/zulu_web/VCMasterPage.master" AutoEventWireup="false" CodeFile="FormNewsService.aspx.vb" Inherits="zulu_cms_editors_NewEditer" %>
...
<td>
 <%--   <cc1:FileSelector ID="btnRefImg" runat="server" Width="400px">
    ...
    <table>
        <tr>
            <td> 
                <asp:FileUpload ID="btnRefImg" runat="server" Enabled="False" /> 

            </td>
            <td>
                <asp:TextBox ID="txtRefImg" runat="server"></asp:TextBox>

            </td>
            <td>เลือก icon <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/" target="_blank">ได้ที่นี่</a></td>
        </tr>
...
<td>
    <table><tr><td class="auto-style1"> <asp:FileUpload ID="btnRefUrl" runat="server" /></td><td class="auto-style1">

      <%--  <asp:Label ID="lblRefUrl" runat="server" Text="Label"></asp:Label>--%>
        <asp:TextBox ID="txtRefUrl" runat="server"></asp:TextBox>
        </td></tr></table> 
