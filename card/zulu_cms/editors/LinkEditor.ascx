<%@ Control Language="VB" AutoEventWireup="false" CodeFile="LinkEditor.ascx.vb" Inherits="zulu_cms_editors_LinkEditor" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataButtonEditColumn Caption="URL" FieldName="refUrl" 
            VisibleIndex="5">
            <PropertiesButtonEdit Width="200px">
                <Buttons>
                    <dx:EditButton>
                        <Image Url="~/zulu_web/images/search.gif">
                        </Image>
                    </dx:EditButton>
                </Buttons>
                <ValidationSettings>
