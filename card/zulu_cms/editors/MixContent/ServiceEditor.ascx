<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ServiceEditor.ascx.vb" Inherits="zulu_cms_editors_NewsCard" %>
...
<script type="text/javascript">
    ...
    function showEditor(newsID) {
        window.location = "Editor.aspx?editor=mixcontent/ServiceForm&ItemID=" + newsID + "&contentID=" + contetID;
    }
</script>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [itemID], [title], [modifyDate], [modifyBy], [createDate], [createBy],[contentType],orderNo,refUrl,imgURL FROM [ZCMS_CONTENT] WHERE ([contentID] = @contentID) and ([siteID]=@siteID)  order by itemID desc" 
