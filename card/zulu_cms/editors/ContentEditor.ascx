<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ContentEditor.ascx.vb" Inherits="zulu_cms_editors_NewsEditor" %>
...
<script type="text/javascript">
    ...
    function showEditor(newsID) {
        window.location = "Editor.aspx?editor=ContentForm&itemID=" + newsID + "&contentID=" + contetID;
    }
</script>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [itemID], [title], [modifyDate], [modifyBy], [createDate], [createBy],[contentType],orderNo FROM [ZCMS_CONTENT] WHERE ([contentID] = @contentID) and ([siteID]=@siteID)  ORDER BY [orderNo]" 
