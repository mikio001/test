<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NewCardForm.ascx.vb" Inherits="zulu_cms_editors_NewsAdd" %><%@ Register assembly="DevExpress.Web.v21.1, Version=21.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
...
<td>ลำดับการแสดง:</td>
<td>
    <dx:ASPxSpinEdit ID="seOrderNo" runat="server" Height="21px" Number="0" 
        Width="60px" />
    </td>
</tr>
<tr>
...
<td>ยุธศาสตร์</td>
<td>
    <dx:ASPxComboBox ID="cmbSTRATEGIC" runat="server" ClientIDMode="AutoID" 
        DataSourceID="SqlDataSource2" TextField="StrategicName" 
        ValueField="StrategicID" ValueType="System.Int32">
    </dx:ASPxComboBox>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ZuluDB %>" SelectCommand="SELECT * FROM [ZCMS_CONTENT_STRATEGIC]"></asp:SqlDataSource>
    </td>
</tr>
<tr>
