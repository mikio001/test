<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GalleryForm.ascx.vb" Inherits="zulu_cms_editors_NewsAdd" %><%@ Register assembly="DevExpress.Web.v21.1, Version=21.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
...
<td>
    <dx:ASPxTextBox ID="subtitle" runat="server" MaxLength="255" Width="400px">
        <ValidationSettings>
            <RequiredField ErrorText="โปรดกรอก" IsRequired="True" />
        </ValidationSettings>
    </dx:ASPxTextBox>
...
<td>ไฟล์เอกสาร:</td>
<td>
    <cc1:FileSelector ID="btnRefUrl" runat="server" Width="400px">
    </cc1:FileSelector>
    </td>
</tr>
    <tr>
<td valign="top" colspan="2">หรือ เนื้อหา:</td>
    </tr>
    <tr>
