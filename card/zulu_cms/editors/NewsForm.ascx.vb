...
Partial Class zulu_cms_editors_NewsAdd
    ...
    Private Sub Save_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
            ...
            db.Execute("update ZCMS_CONTENT set title=@title,contentBody=@html,createDate=GETDATE(),modifyDate=GETDATE(),modifyBy=@username,contentType=@contentType,status=0,refUrl=@refUrl,imgUrl=@refImg,subTitle=@subTitle where itemID=@newsID", db.NewParam("title", newsTitle.Text), db.NewParam("html", FckEditor1.HTML), db.NewParam("username", Zulu.Security.Factory.UserProvider.GetCurrentUsername), db.NewParam("newsID", newsID), db.NewParam("contentType", cmbContentType.Value), db.NewParam("refUrl", btnRefUrl.Text), db.NewParam("subTitle", newsSubTitle.Text), db.NewParam("refImg", btnRefImg.Text))
        End If
