...
Partial Class Main_DefaultPage_MasterPageMetro
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsNothing(Session("security")) Then
            ...
            End If
            '   lblAuthenMenu = "<span class='glyphicon glyphicon-list-alt' style='color:gray;font-size:25px' aria-hidden='true'></span> <button type='button'  class='btn btn-danger' onclick='window.location.href=&#39;../DefaultPage/Logout.aspx&#39;'>Logout</button>"
        Else
