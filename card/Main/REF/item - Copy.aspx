<%@ Page Title="" Language="VB" MasterPageFile="~/Main/DefaultPage/MasterPageAUTH.master" AutoEventWireup="false" CodeFile="item - Copy.aspx.vb" Inherits="Main_COFFEE_ManageTable" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       <%
           ...
           If txt_search.Value = "--" Then
               builder.Append("AND (ck LIKE N'%" + txt_search.Value + "%')")
           ElseIf txt_search.Value = "//" Then
               builder.Append("AND (ck LIKE N'%" + txt_search.Value + "%')")
           End If
  ...
  <li class="nav-item">
    ...
    <a class="nav-link active" href="#" onclick="getCheckbox();" ><span class="glyphicon glyphicon-print"></span>  พิมพ์รูปภาพ</a>
       ...
       <%--<asp:Button ID="bntprint" runat="server" Text="พิมพ์รายงานทั้งหมด" CssClass="btn " />--%>
         ...
         <li class="nav-item">
   <dx:ASPxComboBox ID="ASPxComboBox1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2" SelectedIndex="0" TextField="item_status_name" ValueField="item_status">
      </dx:ASPxComboBox>
  </li>
</ul>
