...
Partial Class Main_Report_Print_ReportListGroupbyFac
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Using report As New CrystalDecisions.CrystalReports.Engine.ReportDocument()
            ...
            report.Load(Server.MapPath("print_report_edit.rpt"))

            Dim dtb = db.GetDataTable("SELECT TOP (200)   * FROM  dbo.Card_TB  WHERE  Card_year = 2567 and  Card_ID in (" & ID & ") ORDER BY Card_TYPE,Card_Num")
