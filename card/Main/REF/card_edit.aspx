<%@ Page Title="" Language="VB" MasterPageFile="~/Main/DefaultPage/MasterPageAUTH.master" AutoEventWireup="false" CodeFile="card_edit.aspx.vb" Inherits="Main_REF_Default2" %>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
    ...
    <asp:SqlDataSource ID="event" runat="server" ConnectionString="<%$ ConnectionStrings:MAINDB %>" SelectCommand="SELECT event_id, event_name FROM event_TB WHERE (event_id = 1) OR (event_id = 2)">
    </asp:SqlDataSource>
