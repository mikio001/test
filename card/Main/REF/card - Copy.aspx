<%@ Page Title="" Language="VB" MasterPageFile="~/Main/DefaultPage/MasterPageAUTH.master" AutoEventWireup="false" CodeFile="card - Copy.aspx.vb" Inherits="Main_COFFEE_ManageTable" %>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
        ...
        <Columns>
            ...
            <dx:GridViewDataImageColumn Caption="รูป" FieldName="imgurl" VisibleIndex="2">
                  <EditFormSettings Visible="False" />
               <%--   <DataItemTemplate>
                      <img alt="..." class="auto-style4" onclick='txt_ID.SetValue(&#039;<%#Eval("Card_ID")%>&#039;);loadfile.PerformCallback();$(&#039;#md_show&#039;).modal(&#039;show&#039;);' src='img/<%#Eval("Card_img")%>'> </img>
                  </DataItemTemplate>--%>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MAINDB %>" SelectCommand="SELECT Card_Num, Card_Name, Card_Surname, CitizenID, Card_Job, Card_duty, Card_FAC_Name, Card_TYPE, Card_Status, Card_img, IMG_File_TEMP, Card_ID, Card_year, Card_edit_ID, '~/Main/REF/img/' + Card_img AS imgurl FROM Card_TB WHERE (Card_TYPE = @Card_TYPE) AND (Card_year = 2567) ORDER BY Card_Num" DeleteCommand="DELETE FROM [Card_TB] WHERE [Card_ID] = @Card_ID" InsertCommand="INSERT INTO Card_TB(Card_Num, Card_Name, Card_Surname, Card_Job, Card_duty, Card_TYPE, Card_Status, Card_img, CitizenID, Card_FAC_Name, Card_year, Card_edit_ID) VALUES (@Card_Num, @Card_Name, @Card_Surname, @Card_Job, @Card_duty, @Card_TYPE, @Card_Status, N'nophoto.jpg', @CitizenID, @Card_FAC_Name, 2567, @Card_edit_ID)" UpdateCommand="UPDATE Card_TB SET Card_Num = @Card_Num, Card_Name = @Card_Name, Card_Surname = @Card_Surname, Card_Job = @Card_Job, Card_duty = @Card_duty, Card_TYPE = @Card_TYPE, Card_Status = @Card_Status, CitizenID = @CitizenID, Card_FAC_Name = @Card_FAC_Name, Card_edit_ID = @Card_edit_ID WHERE (Card_ID = @Card_ID)">
        <DeleteParameters>
